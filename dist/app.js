...
module.exports = !__webpack_require__(43) && !__webpack_require__(59)(function(){
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(11)(proto, TO_PRIMITIVE, __webpack_require__(240));
...
var global     = __webpack_require__(2)
  , $export    = __webpack_require__(0)
  , invoke     = __webpack_require__(63)
  , partial    = __webpack_require__(332)
...
var _classCallCheck2 = __webpack_require__(349);

var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);

var _createClass2 = __webpack_require__(350);

var _createClass3 = _interopRequireDefault(_createClass2);

var _possibleConstructorReturn2 = __webpack_require__(351);
  ...
  (0, _createClass3.default)(NameForm, [{
    ...
    value: function render() {
      return React.createElement(
        'form',
        { action: 'add_player.php', className: 'add_player_form register_form', method: 'post' },
        React.createElement(
          'div',
          ...
          React.createElement('input', { type: 'text', name: 'name_player', id: 'name_input', value: this.state.value, placeholder: 'Podaj imi\u0119 gracza', required: true })
        ),
        React.createElement(
          'div',
          { className: 'form-group' },
          ...
          React.createElement('input', { type: 'text', name: 'surname_player', id: 'surname_input', value: this.state.value, placeholder: 'Podaj nazwisko gracza', required: true })
        ),
        React.createElement(
          'div',
          { className: 'form-group' },
          ...
          React.createElement('input', { type: 'date', name: 'age', id: 'date_input', value: this.state.value, required: true })
        ),
        React.createElement(
          'div',
          { className: 'form-group' },
          ...
          React.createElement('input', { type: 'text', name: 'country', id: 'country_input', value: this.state.value, placeholder: 'Podaj kraj pochodzenia', required: true })
        ),
        React.createElement(
          'div',
          { className: 'form-group' },
          ...
          React.createElement('input', { type: 'text', name: 'formation', id: 'formation_input', value: this.state.value, placeholder: 'Wpisz pozycje', required: true })
        ),
        React.createElement(
          'div',
          { className: 'form-group' },
          ...
          React.createElement('input', { type: 'text', name: 'position', id: 'formation_input', value: this.state.value, placeholder: 'Okre\u015Bl pozycje', required: true })
        ),
        React.createElement(
          'div',
          { className: 'input-group checkbox_div' },
          React.createElement(
            'div',
            ...
            React.createElement(
              'label',
              null,
              React.createElement('input', { type: 'checkbox', value: 'prawa', name: 'betterfoot' }),
              'Prawa'
            )
          ),
          React.createElement(
            ...
            React.createElement(
              'label',
              null,
              React.createElement('input', { type: 'checkbox', value: 'lewa', name: 'betterfoot' }),
              'Lewa'
            )
          ),
          React.createElement(
            ...
            React.createElement(
              'label',
              null,
              React.createElement('input', { type: 'checkbox', name: 'betterfoot', value: 'ObXno\u017Cny' }),
              'ObXno\u017Cny'
            )
          ),
          React.createElement(
            ...
            React.createElement('input', { type: 'number', name: 'height_input', id: 'height_input', value: this.state.value, placeholder: 'Podaj wzrost (cm) ', required: true })
          ),
          React.createElement(
            'div',
            { className: 'form-group' },
            ...
            React.createElement('input', { type: 'number', name: 'weight_input', id: 'weight_input', value: this.state.value, placeholder: 'Podaj wag\u0119 (kg) ', required: true })
          )
        ),
        React.createElement('input', { type: 'submit', className: 'btn btn-primary', name: 'add_player_button', value: 'Dodaj pi\u0142karza do bazy' })
      );
    }
  }]);
  return NameForm;
...
ReactDOM.render(React.createElement(NameForm, null), document.getElementById('test_div'));
...
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !__webpack_require__(43), 'Object', {defineProperty: __webpack_require__(42).f});
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(52)(IteratorPrototype, __webpack_require__(53)('iterator'), function(){ return this; });
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(143)(Function.call, __webpack_require__(155).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch(e){ buggy = true; }
      return function setPrototypeOf(O, proto){
